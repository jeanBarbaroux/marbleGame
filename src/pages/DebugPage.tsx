        ...
        <>
            ...
            <KeyboardControls map={[]}>
                <Canvas shadows camera={{fov: 45, near: 0.1, far: 200, position: [2.5, 4, 6]}}>
                    ...
                    {debugObject.showGridX &&
                        <Grid infiniteGrid cellThickness={0.1} sectionSize={1} rotation-x={Math.PI * 0.5}/>}
                    {debugObject.showGridZ &&
                        <Grid infiniteGrid cellThickness={0.1} sectionSize={1} rotation-z={-Math.PI * 0.5}/>}
